...
exports.emailTemplates = {
    paymentConfirmation: (email, reference, amount) => `
  ...
  `,
    auditionSchedule: (name, date, time) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  `,
    votingPush: (name, contestantName) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
  ...
  `,
    paymentVerification: (email, verificationLink, reference) => `
    <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
