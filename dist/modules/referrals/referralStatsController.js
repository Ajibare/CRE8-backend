...
exports.exportReferralData = exports.getReferralStatistics = void 0;
...
const getReferralStatistics = async (req, res) => {
    try {
        ...
        const totalRegisteredUsers = await User_1.default.countDocuments();
...
const exportReferralData = async (req, res) => {
    try {
        ...
        const referredUsers = await User_1.default.find({ referralCode: { $exists: true, $ne: null } }, { name: 1, email: 1, referralCode: 1, createdAt: 1, _id: 0 }).sort({ referralCode: 1, createdAt: -1 });
        // Get all users without referral codes (organic)
        const organicUsers = await User_1.default.find({ $or: [{ referralCode: { $exists: false } }, { referralCode: null }] }, { name: 1, email: 1, createdAt: 1, _id: 0 }).sort({ createdAt: -1 });
        // Create CSV header
...
exports.exportReferralData = exportReferralData;
//# sourceMappingURL=referralStatsController.js.map