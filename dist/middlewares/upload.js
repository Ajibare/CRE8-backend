...
const fileFilter = (req, file, cb) => {
    const allowedTypes = cloudinary_1.cloudinaryConfig.allowedFormats;
...
exports.upload = (0, multer_1.default)({
    storage,
    limits: {
        fileSize: cloudinary_1.cloudinaryConfig.maxFileSize,
    },
    fileFilter,
});
const uploadToCloudinary = async (file, folder = 'general') => {
    return new Promise((resolve, reject) => {
        cloudinary_1.default.uploader.upload_stream({
            ...
            folder: `${cloudinary_1.cloudinaryConfig.folder}/${folder}`,
...
const autoDetectResourceType = (mimetype) => {
