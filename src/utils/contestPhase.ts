...
export const getCurrentPhase = (): ContestPhase => {
  const now = new Date();
...
export const canSubmitInAudition = async (userId: string, Submission: any): Promise<boolean> => {
...
export const canSubmitInContest = async (
  userId: string, 
  Submission: any, 
  isSelected: boolean
